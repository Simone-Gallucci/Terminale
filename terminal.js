    ...
    new Vue({
        ...
        methods: {
            ...
            execute(cmd) {
                ...
                switch (base) {
                    case "ls":
                        ...
                        break;
                    case "pwd":
                        this.output.push(this.path.join("/") || "/");
                        break;
                    case "cd":
                        this.cd(rest[0]);
                        break;
            ...
            nano(name) {
                ...
                const current = this.currentDir();
                if (!current)
                    return this.output.push("nano: directory non trovata");
